    ...
    >
      ...
      <main className="max-w-6xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <h2 className="text-5xl md:text-6xl font-bold text-text-primary mb-6 leading-tight tracking-tight">
            Everything you share,
            <br />
            <span className="text-accent">in a single link.</span>
          </h2>
          
          <p className="text-xl text-text-primary/70 max-w-2xl mx-auto mb-8 leading-relaxed">
        ...
        <div className="mt-16 pb-8">
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-text-primary/70 max-w-lg mx-auto">
              Swipe left or right to explore Leynk page designs. Every layout looks great on any screen with zero extra work.
            </p>
          </div>
        </div>
